...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/f67bb426834f040b2c1d9515ec132b6b.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/11db262d654d6511228672773eb88c1a.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/d713be22652429a188247aed9f270633.png){:style="width:400px"}
...
???+ tip "Tip"
    ...
    ???+ example "例子"
        ...
        === "十六进制表示"
            ...
            ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/efe22c1098063cc89495bb75fc467a4d.png){:style="width:400px"}
        ...
        === "名称表示"
            ...
            ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/ddd55f93699929baccb59a490609d15a.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/e1a4c83b7917f23d11890cba3cdb34e9.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/9719ff42ceeabe6ac5fdf231c4a9afa1.png){:style="width:400px"}
...
???+ example "例子"
    ...
    === "设置标记大小" 
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/ffd861fb8ac9967cfa11376a679f0240.png){:style="width:400px"}
    ...
    === "设置标记内部颜色"
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/3e165ef0d8edff27cfb3fb8b86eb685a.png){:style="width:400px"}
    ...
    === "设置标记外边框颜色"
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/65aeaa5dd25808601a8eec99158a8d1f.png){:style="width:400px"}       
...
???+ example "例子"
    ...
    === "多次调用绘图函数"
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/d25107b5e9b966db223b2e225e23722a.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/ee38ebfaab09fb4a24e167eb3895d7ea.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/bd81521408e628aa77142f716b6e6aae.png){:style="width:400px"}
...
- `<which>`: 可选, 可选值有`major`, `minor`和`both`, 表示应用于主网格线还是副网格线
    ...
    ???+ example "例子"
        ...
        === "只开启主刻度"
            ...
            ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2bf12a515837e780a9688f23e984c844.png){:style="width:400px"}
        ...
        === "只开启副刻度"
            ...
            ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/4d2da490fb92e3c6d63e250b421d07c7.png){:style="width:400px"}
        ...
        === "开启所有刻度"
            ...
            ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/9ccf579064b452539f92793e20df152a.png){:style="width:400px"}
...
???+ example "例子"
    ...
    ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/fd0c1150609821a5984372d9f2e6aca3.png){:style="width:400px"}
...
???+ example "例子"
    ...
    === "例子1"
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/72d9c30756c00e1e8d94687b4148215f.png){:style="width:400px"}
    ...
    === "例子2"
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/6db8ef5393eafe38777627d50d58b2c9.png){:style="width:400px"}
...
???+ example "例子"
    ...
    - 图1
        ...
        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/c78a5526ecbb97496c7d2c1c991ad42a.png){:style="width:400px"}

    - 图2

        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/544302a4aadff87376d1d47a13ff1e47.png){:style="width:400px"}

    - 图3

        ![](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/4ba1d151e7fc6eab6de8e4c6a5ef694c.png){:style="width:400px"}
